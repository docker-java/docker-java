...
public class Info implements Serializable {
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(architecture, containers, containersStopped, containersPaused, containersRunning, cpuCfsPeriod, cpuCfsQuota, cpuShares, cpuSet, debug, discoveryBackend, dockerRootDir, driver, driverStatuses, systemStatus, plugins, executionDriver, loggingDriver, experimentalBuild, httpProxy, httpsProxy, id, ipv4Forwarding, bridgeNfIptables, bridgeNfIp6tables, images, indexServerAddress, initPath, initSha1, kernelVersion, memoryLimit, memTotal, name, ncpu, nEventsListener, nfd, nGoroutines, noProxy, oomKillDisable, osType, oomScoreAdj, operatingSystem, registryConfig, swapLimit, systemTime, serverVersion, clusterStore, clusterAdvertise, swarm, isolation);
