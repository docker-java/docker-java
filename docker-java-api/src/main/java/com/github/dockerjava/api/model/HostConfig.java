...
public class HostConfig implements Serializable {
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(binds, blkioWeight, blkioWeightDevice, blkioDeviceReadBps, blkioDeviceWriteBps, blkioDeviceReadIOps, blkioDeviceWriteIOps, memorySwappiness, nanoCPUs, containerIDFile, cpuPeriod, cpuRealtimePeriod, cpuRealtimeRuntime, cpuShares, cpuQuota, cpusetCpus, cpusetMems, deviceCgroupRules, diskQuota, dnsOptions, groupAdd, ipcMode, cgroup, links, logConfig, memory, memorySwap, memoryReservation, kernelMemory, networkMode, oomKillDisable, init, autoRemove, oomScoreAdj, portBindings, privileged, publishAllPorts, readonlyRootfs, restartPolicy, cpuCount, cpuPercent, ioMaximumIOps, ioMaximumBandwidth, mounts, pidMode, isolation, securityOpts, storageOpt, cgroupParent, volumeDriver, shmSize, pidsLimit, runtime, tmpFs, utSMode, usernsMode, sysctls, consoleSize);
