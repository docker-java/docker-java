package com.github.dockerjava.jaxrs.jersey.client.client;
...
import com.github.dockerjava.core.DockerClientConfigImpl;
import com.github.dockerjava.core.command.BuildImageResultCallback;
import com.github.dockerjava.core.command.LogContainerResultCallback;
import com.github.dockerjava.core.command.PullImageResultCallback;
import com.github.dockerjava.jaxrs.jersey.client.TestDockerCmdExecFactory;
...
public abstract class AbstractDockerClientTest extends Assert {
    ...
    private DockerClientConfigImpl config() {
        return config(null);
    }

    protected DockerClientConfigImpl config(String password) {
        DockerClientConfigImpl.DockerClientConfigBuilder builder = DockerClientConfigImpl.createDefaultConfigBuilder()
