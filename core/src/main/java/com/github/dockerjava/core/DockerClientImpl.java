...
public class DockerClientImpl implements Closeable, DockerClient {
    ...
    private DockerClientImpl() {
        this(DockerClientConfigImpl.createDefaultConfigBuilder().build());
    }
    ...
    private static DockerClientConfigImpl configWithServerUrl(String serverUrl) {
        return DockerClientConfigImpl.createDefaultConfigBuilder().withUri(serverUrl).build();
    }
    ...
    public static DockerClientImpl getInstance(DockerClientConfigImpl dockerClientConfig) {
