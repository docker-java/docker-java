...
public class DockerClientConfigImpl implements DockerClientConfig {
    ...
    DockerClientConfigImpl(URI uri, String version, String username, String password, String email, String serverAddress,
    ...
    private static Properties loadIncludedDockerProperties(Properties systemProperties) {
        try (InputStream is = DockerClientConfigImpl.class.getResourceAsStream("/" + DOCKER_IO_PROPERTIES_PROPERTY)) {
    ...
    public boolean equals(Object o) {
        ...
        DockerClientConfigImpl that = (DockerClientConfigImpl) o;
    ...
    public static class DockerClientConfigBuilder {
        ...
        public DockerClientConfigImpl build() {
            return new DockerClientConfigImpl(uri, version, username, password, email, serverAddress, dockerCfgPath,
                    sslConfig);
        }
    }
