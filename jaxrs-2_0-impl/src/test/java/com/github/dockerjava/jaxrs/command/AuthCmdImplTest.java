...
public class AuthCmdImplTest extends AbstractDockerClientTest {
    ...
    public void testAuth() throws Exception {
        ...
        Assert.assertEquals(response.getStatus(), "Login Succeeded");
    }
    ...
    public void testAuthInvalid() throws Exception {
        ...
        try {
            ...
            Assert.fail("Expected a UnauthorizedException caused by a bad password.");
        } catch (UnauthorizedException e) {
            Assert.assertEquals(e.getMessage(), "Wrong login/password, please try again\n");
        }
    }
}
