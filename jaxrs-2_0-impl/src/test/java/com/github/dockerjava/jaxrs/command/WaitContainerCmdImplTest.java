...
public class WaitContainerCmdImplTest extends AbstractDockerClientTest {
    ...
    public void testWaitContainer() throws DockerException {
        ...
        AbstractDockerClientTest.LOG.info("Container exit code: {}", exitCode);
        ...
        MatcherAssert.assertThat(inspectContainerResponse.getState().isRunning(), Matchers.is(Matchers.equalTo(false)));
