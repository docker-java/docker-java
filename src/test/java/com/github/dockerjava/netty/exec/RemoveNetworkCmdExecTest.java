...
public class RemoveNetworkCmdExecTest extends AbstractNettyDockerClientTest {

    public static final Logger LOG = LoggerFactory.getLogger(RemoveNetworkCmdExecTest.class);
