...
public class KillContainerCmdExecIT extends AbstractNettyDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(KillContainerCmdExecIT.class);
