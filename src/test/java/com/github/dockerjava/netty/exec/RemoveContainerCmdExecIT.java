...
public class RemoveContainerCmdExecIT extends AbstractNettyDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(RemoveContainerCmdExecIT.class);
