...
public class StopContainerCmdExecIT extends AbstractNettyDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(StopContainerCmdExecIT.class);
