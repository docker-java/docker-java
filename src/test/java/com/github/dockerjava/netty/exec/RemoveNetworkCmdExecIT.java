...
public class RemoveNetworkCmdExecIT extends AbstractNettyDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(RemoveNetworkCmdExecIT.class);
