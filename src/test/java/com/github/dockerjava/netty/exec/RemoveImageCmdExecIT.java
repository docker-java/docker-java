...
public class RemoveImageCmdExecIT extends AbstractNettyDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(RemoveImageCmdExecIT.class);
