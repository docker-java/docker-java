...
import com.github.dockerjava.netty.AbstractNettyDockerClientIT;

@Test(groups = "integration")
public class InspectContainerCmdExecIT extends AbstractNettyDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(InspectContainerCmdExecIT.class);
