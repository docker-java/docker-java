...
public class UpdateContainerCmdExecIT extends AbstractNettyDockerClientIT {
    public static final Logger LOG = LoggerFactory.getLogger(UpdateContainerCmdExecIT.class);
