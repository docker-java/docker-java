...
public class InspectContainerCmdImplIT extends AbstractDockerClientIT {

    public static final Logger LOG = LoggerFactory.getLogger(InspectContainerCmdImplIT.class);
