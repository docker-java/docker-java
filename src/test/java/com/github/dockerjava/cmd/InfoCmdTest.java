...
//    private static final Logger LOG = LoggerFactory.getLogger(InfoCmdTest.class);
//
...
//
//    @Rule
//    public DockerRule dRule = new DockerRule(cmdExecFactory);
//
//    @Test
//    public void infoTest() throws DockerException {
//        DockerClient dockerClient = dRule.getClient();
