...
public class ListContainersCmdIT extends CmdIT {
    ...
    private static Map<String, String> testLabel;
    ...
    public void testListContainersWithLabelsFilter() throws Exception {
        ...
        assertEquals(1, filteredContainersByMap.size());
    ...
    public void testStatusFilter() throws Exception {
        ...
        assertEquals(1, filteredContainers.size());
        assertEquals(id1, filteredContainers.get(0).getId());
    ...
    public void testVolumeFilter() throws Exception {
        ...
        assertEquals(1, filteredContainers.size());
        assertEquals(id, filteredContainers.get(0).getId());
    }
    ...
    public void testAncestorFilter() throws Exception {
        dockerRule.getClient().pullImageCmd("busybox:1.24").exec(new PullImageResultCallback())
                .awaitSuccess();
    ...
    public void testExitedFilter() throws Exception {
        ...
        assertEquals((Integer) 42, status);
