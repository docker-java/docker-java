...
public class StatsCmdExec extends AbstrDockerCmdExec<StatsCmd, Void> implements StatsCmd.Exec {
    ...
    protected Void execute(StatsCmd command) {
        ...
        GETCallbackNotifier<Statistics> callbackNotifier = new GETCallbackNotifier<Statistics>(
                new JsonStreamProcessor<Statistics>(Statistics.class), command.getResultCallback(), webTarget);
