...
public class BuildImageCmdExec extends AbstrDockerCmdExec<BuildImageCmd, BuildImageCmd.Response> implements
        BuildImageCmd.Exec {
    ...
    protected ResponseImpl execute(BuildImageCmd command) {
        ...
        Response response = resourceWithOptionalAuthConfig(command, webResource.request()).accept(MediaType.TEXT_PLAIN)
                .post(entity(command.getTarInputStream(), "application/tar"), Response.class);
